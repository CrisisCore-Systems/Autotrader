...
Usage:
    python scripts/artifacts/generate_artifact.py
"""
...
jinja_env = jinja2.Environment(
    loader=jinja2.FileSystemLoader(project_root / "artifacts" / "templates"),
...
class ArtifactGenerator:
    ...
    def _load_metadata_schema(self) -> Dict[str, Any]:
        ...
        schema_path = project_root / "schemas" / "artifact_metadata.json"
...
def main() -> None:
    ...
    generator = ArtifactGenerator(
        ...
        output_path=project_root / "artifacts" / "dashboard.html",
