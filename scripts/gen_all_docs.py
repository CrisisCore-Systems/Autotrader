...
def main():
    ...
    scripts = [
        (project_root / "scripts" / "gen_cli_docs.py", "CLI Reference Documentation"),
        (project_root / "scripts" / "gen_metrics_docs.py", "Metrics Documentation"),
        (project_root / "scripts" / "gen_manpage.py", "Manual Page (Markdown)"),
    ]
