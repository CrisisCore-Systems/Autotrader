...
DEFAULT_CONFIG_PATH = ROOT / "configs" / "alerts.yaml"
LOCAL_CONFIG_PATH = ROOT / "configs" / "alerts.local.yaml"
...
def configure_telegram():
    ...
    # Save real credentials only to the ignored local config.
...
# This local file contains secrets and must stay out of Git.
