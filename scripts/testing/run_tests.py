...
Usage:
    ...
    python scripts/testing/run_tests.py --unit       # Run unit tests only
    python scripts/testing/run_tests.py --coverage   # Run with coverage
    python scripts/testing/run_tests.py --fast       # Skip slow tests
"""
