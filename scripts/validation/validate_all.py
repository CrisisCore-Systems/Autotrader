...
Usage:
    ...
    python scripts/validation/validate_all.py --strict
    python scripts/validation/validate_all.py --category config
"""
...
class ValidationRunner:
    ...
    def __init__(self, strict: bool = False, verbose: bool = True) -> None:
        self.strict = strict
    ...
    def validate_config_files(self) -> None:
        ...
        result = self.run_command(
            [
                sys.executable,
                "scripts/validation/validate_alert_rules.py",
                "--config",
        ...
        result = self.run_command(
            [
                sys.executable,
                "scripts/validation/validate_prompt_contracts.py",
            ],
...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog=(
            "Examples:\n"
            "  python scripts/validation/validate_all.py                    # Run all checks\n"
            "  python scripts/validation/validate_all.py --strict           # Fail on warnings\n"
            "  python scripts/validation/validate_all.py --category config  # Only config checks\n"
            "  python scripts/validation/validate_all.py --quiet            # Minimal output"
        ),
    )
    parser.add_argument(
        "--strict",
