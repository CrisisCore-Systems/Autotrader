...
class InjectionDetector:
    ...
    def detect(self, text: str) -> ValidationResult:
        ...
        return ValidationResult(is_valid=is_valid, threat_level=threat_level, errors=errors, warnings=warnings)
...
class SchemaValidator:
    ...
    def validate(self, data: Any, schema_name: str) -> ValidationResult:
        ...
        if schema_name not in self.SCHEMAS:
            ...
            return ValidationResult(is_valid=False, threat_level=ThreatLevel.MEDIUM, errors=errors, warnings=warnings)
...
class PromptValidator:
    ...
    def validate_output(
        self, output: str, expected_format: str = "text", schema_name: Optional[str] = None
    ) -> ValidationResult:
        """Validate LLM output.
            ...
            try:
                ...
                if schema_name:
                    ...
                    if not schema_result.is_valid:
                        ...
                        threat_level = max(
                            threat_level, schema_result.threat_level, key=lambda x: list(ThreatLevel).index(x)
                        )
...
def validate_llm_output(
    output: str, expected_format: str = "text", schema_name: Optional[str] = None
) -> ValidationResult:
