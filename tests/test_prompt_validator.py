...
class TestSchemaValidator:
    ...
    def test_invalid_sentiment_value(self):
        ...
        validator = SchemaValidator()
        data = {"sentiment": "invalid_sentiment", "themes": [], "momentum": 0.5}
    ...
    def test_out_of_range_values(self):
        ...
        validator = SchemaValidator()
        data = {"sentiment": "bullish", "themes": [], "momentum": 1.5}  # out of 0-1 range
    ...
    def test_array_length_limits(self):
        ...
        validator = SchemaValidator()
        data = {"sentiment": "neutral", "themes": ["theme"] * 15, "momentum": 0.5}  # exceeds maxItems: 10
    ...
    def test_valid_safety_analysis(self):
        ...
        validator = SchemaValidator()
        data = {"is_safe": True, "risk_level": "low", "findings": ["No major red flags"], "confidence": 0.9}
...
class TestPromptValidator:
    ...
    def test_validate_json_output_valid(self):
        ...
        result = validator.validate_output(json_output, expected_format="json", schema_name="narrative_analysis")
        assert result.is_valid
...
class TestConvenienceFunctions:
    ...
    def test_validate_llm_output_with_schema(self):
        ...
        result = validate_llm_output(json_output, expected_format="json", schema_name="narrative_analysis")
        assert result.is_valid
